...
## Confirm with the pantry before public launch
- Current address, phone, distribution dates, and hours.
- Eligibility, documentation, registration and accessibility arrangements.
- Accepted donations, drop-off times and volunteer opportunities.
- Approved financial donation method, legal/tax wording and brand identity.
- Pantry approval of copy and imagery. Current sprout wordmark is a proposed identity, not an existing official logo.
- Remove noindex only when approved for public search indexing.

## Image
Illustrative market produce; does not depict the actual pantry or promise specific available foods.
Ashley Winkler / Unsplash: https://unsplash.com/photos/assorted-vegetables-on-green-plastic-crate-53f1vbOG7y8
Downloaded from https://images.unsplash.com/photo-1599660869952-3852916ff82b?auto=format&fit=crop&w=1800&q=85
Free use under https://unsplash.com/license . Attribution appreciated, not required.
